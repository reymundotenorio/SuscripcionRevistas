...
import Principal.RevistaP;
import Principal.SuscriptorP;
...
//        
    ...
    private SuscriptorP Suscriptor;
    private RevistaP Revista;

    public void setRevista(RevistaP Revista) {
        this.Revista = Revista;
    }

    public void setSuscriptor(SuscriptorP Suscriptor) {
...
if(chAutoRostro.isSelected()){
    ...
    public void Cerrar(){
       ...
       if(Revista!=null){
       this.Revista.setVisible(true);
      }
      if(Suscriptor!= null ){
      this.Suscriptor.setVisible(true);
      }
      ...
      if(e.getClickCount()==2){
        ...
        for(int i=0;i<Foto.length;i++){
            if(E.equals(Foto[i])){
                ...
                VIF.setSuscriptor(Suscriptor);
                VIF.setRevista(Revista);
                VIF.setWebCam(this);
                VIF.setVisible(true);
            }    
        }
...
//           
    ...
    String Path = Ruta.concat("Capture_").concat(Fecha).concat("_"+AM_PM).concat(".jpg");
   // cvSaveImage(Path, img);
          ...
          ImageIO.write((RenderedImage) imagen, "jpg", file);
    ...
    if(Suscriptor == null && Revista == null){    
    ActualizarExplorer();
    LoadFilesFolder();
