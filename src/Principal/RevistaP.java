 ...
 */
public class RevistaP extends javax.swing.JFrame {
    ...
    public RevistaP() {
         ...
         try{
        this.setIconImage (new ImageIcon(getClass().getResource("/Imagenes/Revistas.png")).getImage());
    ...
    private void initComponents() {
        ...
        MnItemFoto.setToolTipText("Ver Fotografía de La Revista");
        ...
        MnItemActDes.setToolTipText("Activar Revista");
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Información Nueva Revista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(204, 204, 204))); // NOI18N
        ...
        txtMatricula.setToolTipText("Ingrese Apellidos del Estudiante");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCuota, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fotografía Revista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(204, 204, 204))); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(48, 97, 0, 15);
        jPanel6.add(jPanel9, gridBagConstraints);

        PanelNuevo.add(jPanel6, java.awt.BorderLayout.CENTER);

        TabbedPane.addTab("Nueva Revista", PanelNuevo);
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Revista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(204, 204, 204))); // NOI18N
        ...
        cmbbusc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No.", "Título Revista", "Matricula Revista", "Cuota Revista", "Estado" }));
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fotografía Revista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(204, 204, 204))); // NOI18N
        ...
        TabbedPane.addTab("Ver Revistas", PanelVer);
    ...
    public void Guardar (){
        ...
        String Titulo, Apellidos, Foto, Matri, Cuot;
        double Matricula, Cuota;
        
        Titulo = txtNombre.getText().trim();
        Apellidos = txtMatricula.getText().trim();
        Matri = txtMatricula.getText().trim();
        Cuot = txtCuota.getText().trim();
        
        Matricula = Double.parseDouble(Matri);
        Cuota = Double.parseDouble(Cuot);
        ...
        if("".equals(Apellidos))  {
            ...
            JOptionPane.showMessageDialog(this,"Ingrese El Monto de La Matricula de La Revista","Ingrese",JOptionPane.ERROR_MESSAGE);
            return;
        }
             
                 if("".equals(Cuot)){

            JOptionPane.showMessageDialog(this,"Ingrese El Monto de La Cuota de La Revista","Ingrese",JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if("".equals(Foto))  {
            JOptionPane.showMessageDialog(this,"Seleccione La Fotografía de La Revista","Ingrese",JOptionPane.ERROR_MESSAGE);
            return;
           }
            ...
            if(Modify==true){
               ...
               Revista.Actualizar_Revista(ID, Titulo, Cuota, Matricula, Foto);
             ...
             Revista.Agregar_Revista(Titulo, Cuota, Matricula, Foto);
   ...
   public void ActualizarTabla(){
       ...
       jTable1.setModel(model);
        ...
        resultado = Conexion.consulta("Select * from revistav");
       ...
       {     
              ...
              Datos [3]= String.valueOf(resultado.getDouble(3));
              Datos [4]= String.valueOf(resultado.getDouble(4));
...
//        jTable1.getColumnModel().getColumn( 10 ).setCellRenderer(new Render_CheckBox());      
    ...
    public void Buscar(){
        ...
        switch(index){
            ...
            try{
                ...
                resultado = Conexion.consulta("Select * from revistav where ID_Revista = '"+Buscar+"'");
              ...
              model.addRow(Datos);  
                ...
                JOptionPane.showMessageDialog(null,"No. de Revista No Encontrado");
            }
            ...
            try{
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Titulo = '"+Buscar+"'");
            ...
            try{
             model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Matricula = '"+Buscar+"'");
              ...
              model.addRow(Datos);  
                ...
                JOptionPane.showMessageDialog(null,"Matricula de La Revista No Encontrado");
            }
            ...
            case 4:
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Cuota = '"+Buscar+"'");
            ...
            case 5:
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Estado_Revista = '"+Buscar+"'");
              ...
              model.addRow(Datos);  
                ...
                JOptionPane.showMessageDialog(null,"Estado de La Revista No Encontrado");
            }
    ...
    private void txtbuscKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscKeyReleased
        ...
        switch(index){
            ...
            try{
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where ID_Revista like '%"+Buscar+"%'");
            ...
            try{
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Titulo like '%"+Buscar+"%'");
            ...
            try{
             model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Matricula like '%"+Buscar+"%'");
            ...
            case 4:
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Cuota like '%"+Buscar+"%'");
            ...
            case 5:
                ...
                model.setRowCount(0);
                String Buscar = txtbusc.getText();
                resultado = Conexion.consulta("Select * from revistav where Estado_Revista like '%"+Buscar+"%'");
   ...
   resultado = Conexion.consulta("Select Imagen_Revista from revista where ID_Revista = "+ID);
     ...
     if (resultado.next()){
            ...
            jLblFoto1.setIcon(newIcon);
                 ...
                 {
                         JOptionPane.showMessageDialog(null, "La Revista No Posee Fotografía","Error",JOptionPane.ERROR_MESSAGE);
...
MnItemActDes.setToolTipText("Desactivar Revista");
}
  ...
  ActivarBotones(); // TODO add your handling code here:
    ...
    public void ActivarDesactivarRevista(){
        int fila = jTable1.getSelectedRow();
        ...
        if (fila > -1){
            ...
            Matricula = ((String)this.jTable1.getModel().getValueAt(fila, 3));
            Cuota = ((String)this.jTable1.getModel().getValueAt(fila, 4));
            ...
            if("Activo".equalsIgnoreCase(Estado)){
                ...
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar La Revista "+Nombre.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }
            if("Inactivo".equalsIgnoreCase(Estado)){
             
                v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar La Revista "+Nombre.trim()+"?", "Confirmación", JOptionPane.YES_NO_OPTION);
            }

            if(v==JOptionPane.YES_OPTION){

                
                Revista.Activar_Desactivar_Revista(ID);
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Una Revista a Activar/Desactivar", "Error", JOptionPane.ERROR_MESSAGE);
...
//            }
             ...
             v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Activar Revista(s) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<jTable1.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Revista.Activar_Revista(ID);
         }
               
            }
         JOptionPane.showMessageDialog(this, "Revista(s) Activada(s) Con Éxito", "Activado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
...
//        }
   ...
   v= JOptionPane.showConfirmDialog(this, "Está Seguro Que Desea Desactivar Revista(s) ?", "Confirmación", JOptionPane.YES_NO_OPTION);
        ...
        for(int i=0; i<jTable1.getRowCount();i++){
         ...
         if(Flag == true){
               ...
               Revista.Desactivar_Revista(ID);
         }
               
            }
        
        JOptionPane.showMessageDialog(this, "Revista(s) Desactivada(s) Con Éxito", "Desactivado(s) Con Éxito", JOptionPane.INFORMATION_MESSAGE);
...
// TODO add your handling code here:
    ...
    public void Modificar(){
      ...
      ActivarBotones();
        ...
        int ID;
        String Nombres, Cuota, Matricula;  
     ...
     if (resultado.next()){
            ...
            JOptionPane.showMessageDialog(this, "Seleccione Una Revista a Modificar", "Error", JOptionPane.ERROR_MESSAGE);
...
char c = evt.getKeyChar();
        ...
        if("0".equals(txtMatricula.getText())&&txtMatricula.getCaretPosition()==1&&c!='.'&&!Character.isISOControl(c)){
      txtMatricula.setText(txtMatricula.getText()+".");
   //   return;
}

        if (c == '.' && txtMatricula.getText().contains(".")) {
            Toolkit.getDefaultToolkit().beep();
            evt.consume();
            return;
        }
        ...
        String x1 = "";
         if(Character.isDigit(c)||(Character.isISOControl(c)&&!"".equals(txtMatricula.getText()))){
            x1 = txtMatricula.getText();
        }
        if(Character.isDigit(c)||(c == '.')){
            x1 = txtMatricula.getText().concat(String.valueOf(c));
        }
...
ReiniciarTabla();// TODO add your handling code here:
   ...
   public void ReiniciarTabla(){
        ...
        Object [] Titulo = {"","No.", "Título", "Matricula",
            "Cuota", "Estado"};
        ...
        jTable1.setDefaultRenderer(Object.class, new FormatoTablaRevista());
...
ActivarDesactivarRevista();        // TODO add your handling code here:
...
VerFotoRevista();        // TODO add your handling code here:
...
char c = evt.getKeyChar();
   ...
   //   return;
    ...
    public boolean isCellEditable(int row, int column) {
     ...
     public class FormatoTablaRevista extends DefaultTableCellRenderer
{
 @Override
